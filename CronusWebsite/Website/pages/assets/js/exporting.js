  ...
  (function(f) {
    ...
    t(A.prototype, {
      ...
      getSVG: function(a) {
        ...
        a &&
          k(["xAxis", "yAxis", "series"], function(c) {
            var d = {};
      ...
      contextMenu: function(a, b, e, c, v, m, g) {
        ...
        b = { display: "block" };
        e + d.exportMenuWidth > h
          ? (b.right = h - e - v - x + "px")
          : (b.left = e - x + "px");
        c + m + d.exportMenuHeight > G && "top" !== g.alignOptions.verticalAlign
          ? (b.bottom = G - c - x + "px")
          : (b.top = c + m - x + "px");
        u(l, b);
        d.openMenu = !0;
      ...
      addButton: function(a) {
        ...
        if (!1 !== c.enabled) {
          ...
          c.text && c.symbol
            ? (h.paddingLeft = r(h.paddingLeft, 25))
            : c.text || t(h, { width: c.width, height: c.height, padding: 0 });
          d = e
            .button(c.text, 0, 0, l, h, q, k)
          ...
          d.add().align(
            t(c, { width: d.width, x: r(c.x, b.buttonOffset) }),
            !0,
            "spacingBox"
          );
          b.buttonOffset +=
