  ...
  (function(a) {
    ...
    a.Chart.prototype.getDataRows = function(f) {
          ...
          return b
            ? b instanceof a.Axis
              ? (b.options.title && b.options.title.text) ||
                (b.isDatetimeAxis ? "DateTime" : "Category")
              : f
                ? {
      ...
      c(this.series, function(b) {
        ...
        if (
          !1 !== b.options.includeInCSVExport &&
          ...
          for (t = 0; t < k; )
            (A = E(b, d[t], d.length)),
              v.push(A.columnTitle || A),
              f && D.push(A.topLevelColumnTitle || A),
              t++;
          n = {
            chart: b.chart,
          ...
          c(b.options.data, function(a, f) {
            ...
            r[a].x = l.x;
            r[a].xValues[y] = l.x;
            (b.xAxis && "name" !== b.exportKey) ||
              (r[a].name = b.data[f] && b.data[f].name);
            for (; t < k; )
              (f = d[t]),
                (c = l[f]),
                (r[a][w + t] = m(
                  p[f][c],
                  e[f] ? g.dateFormat(h.dateFormat, c) : null,
                  c
                )),
                t++;
          });
      ...
      for (w = B.length; w--; )
        (x = B[w][0]),
          ...
          (k = E(d)),
          p[0].splice(y, 0, k),
          f && p[1] && p[1].splice(y, 0, k),
          c(e, function(b) {
            var a = b.name;
            d &&
              !z(a) &&
              (d.isDatetimeAxis
                ? (b.x instanceof Date && (b.x = b.x.getTime()),
                  (a = g.dateFormat(h.dateFormat, b.x)))
                : (a = d.categories
                    ? m(d.names[b.x], d.categories[b.x], b.x)
                    : b.x));
            b.splice(y, 0, a);
          });
      return (p = p.concat(e));
    ...
    a.Chart.prototype.getTable = function(a) {
      ...
      !1 !== h.exporting.tableCaption &&
        (f +=
          '\x3ccaption class\x3d"highcharts-table-caption"\x3e' +
          m(
            h.exporting.tableCaption,
            h.title.text
              ? h.title.text
                  .replace(/&/g, "\x26amp;")
                  .replace(/</g, "\x26lt;")
      ...
      f += (function(a, d, c) {
              ...
              b === k
                ...
                : g
                  ? ((f += q(
                      ...
                      'scope\x3d"col" colspan\x3d"' + (g + 1) + '"',
                      b
                    )),
                    (g = 0))
                  : (b === d[e]
                      ? h.exporting.useRowspanHeaders
                        ? ((k = 2), delete d[e])
                        : ((k = 1), (d[e] = ""))
                      : (k = 1),
                    (f += q(
        ...
        if (d) {
          ...
          for (c = d.length; e < c; ++e)
            void 0 !== d[e] && (f += q("th", null, 'scope\x3d"col"', d[e]));
          f += "\x3c/tr\x3e";
        }
      ...
      c(a, function(a) {
        f += "\x3ctr\x3e";
        for (var d = 0; d < e; d++)
          f += q(d ? "td" : "th", null, d ? "" : 'scope\x3d"row"', a[d]);
        f += "\x3c/tr\x3e";
      });
    ...
    a.Chart.prototype.fileDownload = function(c, g, h) {
      ...
      d = this.options.exporting.filename
        ...
        : this.title && this.title.textStr
          ? this.title.textStr.replace(/ /g, "-").toLowerCase()
          : "chart";
      u.Blob && u.navigator.msSaveOrOpenBlob
        ? ((c = new u.Blob(["\ufeff" + h], { type: "text/csv" })),
          u.navigator.msSaveOrOpenBlob(c, d + "." + g))
        : q
          ? ((h = e.createElement("a")),
            (h.href = c),
            (h.download = d + "." + g),
            ...
            h.click(),
            h.remove())
          : a.error("The browser doesn't support downloading files");
    };
    ...
    a.Chart.prototype.downloadXLS = function() {
      ...
      this.fileDownload(
        "data:application/vnd.ms-excel;base64," +
          u.btoa(unescape(encodeURIComponent(a))),
        "xls",
        a,
    ...
    a.Chart.prototype.viewData = function() {
      this.dataTableDiv ||
        ((this.dataTableDiv = e.createElement("div")),
