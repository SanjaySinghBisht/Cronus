...
$(document).ready(function() {
  ...
  function setMenuLayout() {
    if ($("body").hasClass("menu-bottom")) {
      ...
      $("body").hasClass("horizontal-fixed") ||
      $("body").hasClass("horizontal-static") ||
      $("body").hasClass("horizontal-icon") ||
      $("body").hasClass("horizontal-icon-fixed") ||
      $("body").hasClass("menu-compact")
    ) {
      $(".main-menu-content").slimScroll({ destroy: true });
  ...
  // open chat box
  $(".addTableRecord").on("click", function() {
    var options = {
      direction: "right"
    };
  ...
  $(".close-sidebar").on("click", function() {
    ...
    $(".showChat").hide("slide", options, 500);
  });
  ...
  i18next.use(window.i18nextXHRBackend).init(
    ...
    $(".lng-dropdown a").on("click", function() {
      ...
      $(".lng-dropdown #dropdown-active-item").html(
        "Current Environment Selected is" + drop_lng.html()
      );
    });
